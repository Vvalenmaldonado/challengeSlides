...
export default function HomePage() {
  ...
  const imageVariants = {
    ...
    visible: { opacity: 1, x: 0, transition: { duration: 0.5, ease: "easeInOut", delay: 0.5}},
  };
  ...
  return (
    <section className="mx-auto max-w-[1300px] flex flex-col justify-between items-center sm:px-5 ">
      ...
      <motion.div
        className="lg:w-[55%] sm:w-[85%]"
        initial="hidden" 
        animate="visible" 
        variants={imageVariants} 
      >
      <Image className="w-full"  src="/images/home.png" alt="Logo" width={500} height={500} />
      </motion.div>
      </div>
      <motion.div
       initial="hidden" 
